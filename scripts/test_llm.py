...
def run_llm_test():
    print("--- Starting LLM Service Test (Ollama - Mistral) ---")
    ...
    llm = LLMService(ollama_url="http://localhost:11434", model_name="mistral")
    
    print("\nSending prompt to Ollama (Mistral)... Please wait (this can take 5-20 seconds)...")

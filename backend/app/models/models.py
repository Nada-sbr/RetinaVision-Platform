...
class Image(Base):
    ...
    prediction: Mapped["Prediction"] = relationship("Prediction", back_populates="image", uselist=False, cascade="all, delete-orphan")
...
class Prediction(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, index=True)
    image_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("images.id", ondelete="CASCADE"), nullable=False, unique=True)
